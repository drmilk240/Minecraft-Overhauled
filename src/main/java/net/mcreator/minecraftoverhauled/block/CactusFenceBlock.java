...
public class CactusFenceBlock extends MinecraftOverhauledModElements.ModElement {
	@ObjectHolder("minecraft_overhauled:cactus_fence")
	public static final Block block = null;
	public CactusFenceBlock(MinecraftOverhauledModElements instance) {
		super(instance, 309);
	}
