...
public class MyceliumPathBlock extends MinecraftOverhauledModElements.ModElement {
	@ObjectHolder("minecraft_overhauled:mycelium_path")
	public static final Block block = null;
	public MyceliumPathBlock(MinecraftOverhauledModElements instance) {
		super(instance, 275);
	}
