...
public class CutCopperBlockBlock extends MinecraftOverhauledModElements.ModElement {
	@ObjectHolder("minecraft_overhauled:cut_copper_block")
	public static final Block block = null;
	public CutCopperBlockBlock(MinecraftOverhauledModElements instance) {
		super(instance, 265);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cut_copper_block");
		}
