...
public class OrchidBlock extends MinecraftOverhauledModElements.ModElement {
			...
			configuredFeature = feature
					.withConfiguration(
							(new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(block.getDefaultState()), new SimpleBlockPlacer()))
									.tries(64).build())
					.withPlacement(Features.Placements.VEGETATION_PLACEMENT).withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).func_242731_b(13);
			event.getRegistry().register(feature.setRegistryName("orchid"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("minecraft_overhauled:orchid"), configuredFeature);
		}
	}
	@SubscribeEvent
