...
import net.mcreator.minecraftoverhauled.procedures.AnthillBlockUpdateTickProcedure;
...
public class AnthillBlockBlock extends MinecraftOverhauledModElements.ModElement {
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("anthill_block"));
	}
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				AnthillBlockUpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("anthill_block");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Anthill Hive");
		}
