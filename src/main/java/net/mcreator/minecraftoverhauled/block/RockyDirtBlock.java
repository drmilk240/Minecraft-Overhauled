...
public class RockyDirtBlock extends MinecraftOverhauledModElements.ModElement {
	@ObjectHolder("minecraft_overhauled:rocky_dirt")
	public static final Block block = null;
	public RockyDirtBlock(MinecraftOverhauledModElements instance) {
		super(instance, 277);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("minecraft_overhauled:rocky_dirt_match"),
			...
			event.getRegistry().register(feature.setRegistryName("rocky_dirt"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("minecraft_overhauled:rocky_dirt"), configuredFeature);
		}
	}
	@SubscribeEvent
