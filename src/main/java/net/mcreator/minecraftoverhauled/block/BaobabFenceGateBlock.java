...
public class BaobabFenceGateBlock extends MinecraftOverhauledModElements.ModElement {
	@ObjectHolder("minecraft_overhauled:baobab_fence_gate")
	public static final Block block = null;
	public BaobabFenceGateBlock(MinecraftOverhauledModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("baobab_fence_gate");
		}
