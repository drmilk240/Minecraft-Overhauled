...
public class CharredSoilBlock extends MinecraftOverhauledModElements.ModElement {
	@ObjectHolder("minecraft_overhauled:charred_soil")
	public static final Block block = null;
	public CharredSoilBlock(MinecraftOverhauledModElements instance) {
		super(instance, 234);
	...
	private static class CustomRuleTest extends RuleTest {
		...
		public boolean test(BlockState blockAt, Random random) {
			...
			if (blockAt.getBlock() == CharredRockBlock.block.getDefaultState().getBlock())
				blockCriteria = true;
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("minecraft_overhauled:charred_soil_match"),
