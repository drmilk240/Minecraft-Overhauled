...
public class SoulstoneBlock extends MinecraftOverhauledModElements.ModElement {
	@ObjectHolder("minecraft_overhauled:soulstone")
	public static final Block block = null;
	public SoulstoneBlock(MinecraftOverhauledModElements instance) {
		super(instance, 291);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("minecraft_overhauled:soulstone_match"),
			...
			event.getRegistry().register(feature.setRegistryName("soulstone"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("minecraft_overhauled:soulstone"), configuredFeature);
		}
	}
	@SubscribeEvent
