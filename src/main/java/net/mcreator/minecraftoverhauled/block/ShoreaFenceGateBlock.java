...
public class ShoreaFenceGateBlock extends MinecraftOverhauledModElements.ModElement {

	@ObjectHolder("minecraft_overhauled:shorea_fence_gate")
	public static final Block block = null;

	public ShoreaFenceGateBlock(MinecraftOverhauledModElements instance) {
		super(instance, 53);
	...
	public static class CustomBlock extends FenceGateBlock {
		...
		public CustomBlock() {
			...
			setRegistryName("shorea_fence_gate");
		}
