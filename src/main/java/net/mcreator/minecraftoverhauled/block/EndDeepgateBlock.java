...
import net.mcreator.minecraftoverhauled.procedures.EndDeepgateOnBlockRightClickedProcedure;
...
public class EndDeepgateBlock extends MinecraftOverhauledModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				EndDeepgateOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
