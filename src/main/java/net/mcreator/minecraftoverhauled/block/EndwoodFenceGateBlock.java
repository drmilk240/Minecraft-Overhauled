...
public class EndwoodFenceGateBlock extends MinecraftOverhauledModElements.ModElement {
	@ObjectHolder("minecraft_overhauled:endwood_fence_gate")
	public static final Block block = null;
	public EndwoodFenceGateBlock(MinecraftOverhauledModElements instance) {
		super(instance, 36);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("endwood_fence_gate");
		}
