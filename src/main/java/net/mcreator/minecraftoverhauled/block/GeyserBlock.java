...
public class GeyserBlock extends MinecraftOverhauledModElements.ModElement {
	@ObjectHolder("minecraft_overhauled:geyser")
	public static final Block block = null;
	public GeyserBlock(MinecraftOverhauledModElements instance) {
		super(instance, 238);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.BASALT).hardnessAndResistance(1f, 10f).setLightLevel(s -> 12).harvestLevel(1)
