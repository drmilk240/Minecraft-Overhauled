...
public class CopperGeneratorBlock extends MinecraftOverhauledModElements.ModElement {
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("copper_generator");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Copper Generator");
		}
		...
		private final EnergyStorage energyStorage = new EnergyStorage(1000000, 200, 200, 0) {
			@Override
