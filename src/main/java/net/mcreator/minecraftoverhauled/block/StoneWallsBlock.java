...
public class StoneWallsBlock extends MinecraftOverhauledModElements.ModElement {
	@ObjectHolder("minecraft_overhauled:stone_walls")
	public static final Block block = null;
	public StoneWallsBlock(MinecraftOverhauledModElements instance) {
		super(instance, 300);
	}
