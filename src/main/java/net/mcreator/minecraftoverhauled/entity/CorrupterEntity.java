...
import net.mcreator.minecraftoverhauled.entity.renderer.CorrupterRenderer;
...
public class CorrupterEntity extends MinecraftOverhauledModElements.ModElement {
	public static EntityType entity = null;
	public CorrupterEntity(MinecraftOverhauledModElements instance) {
		super(instance, 276);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CorrupterRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(100).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f))
						.build("corrupter").setRegistryName("corrupter");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -10465476, -16711715, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("corrupter_spawn_egg"));
	}
