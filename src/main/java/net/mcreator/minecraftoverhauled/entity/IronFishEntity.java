...
import net.mcreator.minecraftoverhauled.entity.renderer.IronFishRenderer;
...
public class IronFishEntity extends MinecraftOverhauledModElements.ModElement {
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.WATER_CREATURE).add(new MobSpawnInfo.Spawners(entity, 40, 1, 16));
	}
