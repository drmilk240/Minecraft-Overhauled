...
import net.mcreator.minecraftoverhauled.entity.renderer.RiverDolphinRenderer;
...
public class RiverDolphinEntity extends MinecraftOverhauledModElements.ModElement {
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.WATER_CREATURE).add(new MobSpawnInfo.Spawners(entity, 10, 4, 11));
	}
