...
import net.mcreator.minecraftoverhauled.entity.renderer.AntRenderer;
...
public class AntEntity extends MinecraftOverhauledModElements.ModElement {
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 15, 11, 36));
	}
