...
import net.mcreator.minecraftoverhauled.block.EndwoodLogBlock;
import net.mcreator.minecraftoverhauled.block.EndwoodLeavesBlock;
...
public class VoidwoodsBiome extends MinecraftOverhauledModElements.ModElement {
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-14139839).setWaterFogColor(-14139839)
						.withSkyColor(7972607).withFoliageColor(-12890561).withGrassColor(-12890561)
						.setParticle(new ParticleEffectAmbience(ParticleTypes.WARPED_SPORE, 0.005f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(EndLoamBlock.block.getDefaultState(),
								Blocks.END_STONE.getDefaultState(), Blocks.END_STONE.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(EndwoodLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(EndwoodLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("minecraft_overhauled:voidwoods"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("voidwoods_lvtd");
		...
		protected void func_227424_a_(IWorldWriter ww, BlockPos bp, BooleanProperty bpr, Set<BlockPos> sbc, MutableBoundingBox mbb) {
			this.func_227423_a_(ww, bp, EndwoodLeavesBlock.block.getDefaultState(), sbc, mbb);
		}
	}
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("voidwoods_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("voidwoods_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
