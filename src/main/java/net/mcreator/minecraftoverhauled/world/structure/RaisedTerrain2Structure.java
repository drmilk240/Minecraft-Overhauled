...
public class RaisedTerrain2Structure extends MinecraftOverhauledModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public RaisedTerrain2Structure(MinecraftOverhauledModElements instance) {
		super(instance, 324);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 10000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("minecraft_overhauled", "rockyterrain2"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("raised_terrain_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("minecraft_overhauled:raised_terrain_2"),
					configuredFeature);
		}
	}
	@SubscribeEvent
