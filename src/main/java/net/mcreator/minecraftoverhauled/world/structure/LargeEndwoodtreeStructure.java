...
public class LargeEndwoodtreeStructure extends MinecraftOverhauledModElements.ModElement {
	...
	public LargeEndwoodtreeStructure(MinecraftOverhauledModElements instance) {
		super(instance, 180);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("large_endwoodtree"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("minecraft_overhauled:large_endwoodtree"),
					configuredFeature);
		}
	}
	@SubscribeEvent
