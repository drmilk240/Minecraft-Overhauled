...
public class ConstructedTowerStructure extends MinecraftOverhauledModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public ConstructedTowerStructure(MinecraftOverhauledModElements instance) {
		super(instance, 204);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 5000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("minecraft_overhauled", "buildtower"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("constructed_tower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("minecraft_overhauled:constructed_tower"),
					configuredFeature);
		}
	}
	@SubscribeEvent
