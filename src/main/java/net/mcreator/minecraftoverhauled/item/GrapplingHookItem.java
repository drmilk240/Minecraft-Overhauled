...
public class GrapplingHookItem extends MinecraftOverhauledModElements.ModElement {
	@ObjectHolder("minecraft_overhauled:grappling_hook")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletgrappling_hook").setRegistryName("entitybulletgrappling_hook"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1.4f, 1, 0);
			...
			if (this.inGround) {
				{
					...
					GrapplingHookBulletHitsBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
