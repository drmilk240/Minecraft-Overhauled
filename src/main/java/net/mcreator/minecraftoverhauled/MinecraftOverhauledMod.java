 ...
 *
 *    Keep the MinecraftOverhauledModElements object in this class and all calls to this object
...
@Mod("minecraft_overhauled")
public class MinecraftOverhauledMod {
	public static final Logger LOGGER = LogManager.getLogger(MinecraftOverhauledMod.class);
	private static final String PROTOCOL_VERSION = "1";
	public static final SimpleChannel PACKET_HANDLER = NetworkRegistry.newSimpleChannel(
			new ResourceLocation("minecraft_overhauled", "minecraft_overhauled"), () -> PROTOCOL_VERSION, PROTOCOL_VERSION::equals,
